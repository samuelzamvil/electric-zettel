...
<!-- Add pages under the section that fits. Create sections as the project grows. -->

### Architecture
<!-- e.g. - [[Build System]] — how the project is built -->

### Components
<!-- e.g. - [[Data Model]] — core entities and relationships -->

### Operations
<!-- e.g. - [[Deployment]] — how releases ship -->
